...
const Header = () => {
    ...
    <header className="flex justify-between items-center py-4 px-4 lg:px-20">
        ...
        <nav className="hidden md:flex items-center gap-12">
            ...
            <a data-aos="fade-down"
            data-aos-easing="linear"
            data-aos-duration="2000" className="text-base tracking-wider transition-colors hover:text-grey-300 z-50"
            ...
            <a data-aos="fade-down"
            data-aos-easing="linear"
            data-aos-duration="2500" className="text-base tracking-wider transition-colors hover:text-grey-300 z-50"
            href="https://in.linkedin.com/in/smsanthoshkumar07"
            target="_blank"
            rel="noopener noreferrer"
            >
        ...
        <a href="/santhoshkumarsm_resume.pdf" download>
            <button
        ...
        <div id='mobileMenu' className='hidden fixed top-16 bottom-0 right-0 left-0 p-5 md:hidden z-40 bg-black bg-opacity-70 backdrop-blur-md'>
            <nav className='flex flex-col gap-6 itmens-center'>
                <a className="text-basee tracking-wider transition-colors hover:text-grey-300 z-50" href="#">
                LINKEDIN
            </a>
